...
(cl:defmethod cl:initialize-instance :after ((m <RobotiqTouch>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotiqTouch)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name heartbeat_ros-msg:<RobotiqTouch> is deprecated: use heartbeat_ros-msg:RobotiqTouch instead.")))

(cl:ensure-generic-function 'f0-val :lambda-list '(m))
(cl:defmethod f0-val ((m <RobotiqTouch>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader heartbeat_ros-msg:f0-val is deprecated.  Use heartbeat_ros-msg:f0 instead.")
  (f0 m))

(cl:ensure-generic-function 'f1-val :lambda-list '(m))
(cl:defmethod f1-val ((m <RobotiqTouch>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader heartbeat_ros-msg:f1-val is deprecated.  Use heartbeat_ros-msg:f1 instead.")
  (f1 m))

(cl:ensure-generic-function 'f2-val :lambda-list '(m))
(cl:defmethod f2-val ((m <RobotiqTouch>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader heartbeat_ros-msg:f2-val is deprecated.  Use heartbeat_ros-msg:f2 instead.")
  (f2 m))
