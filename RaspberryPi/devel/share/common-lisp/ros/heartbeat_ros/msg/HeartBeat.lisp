...
(cl:defmethod cl:initialize-instance :after ((m <HeartBeat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeartBeat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name heartbeat_ros-msg:<HeartBeat> is deprecated: use heartbeat_ros-msg:HeartBeat instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <HeartBeat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader heartbeat_ros-msg:header-val is deprecated.  Use heartbeat_ros-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'bpm-val :lambda-list '(m))
(cl:defmethod bpm-val ((m <HeartBeat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader heartbeat_ros-msg:bpm-val is deprecated.  Use heartbeat_ros-msg:bpm instead.")
  (bpm m))

(cl:ensure-generic-function 'oxygen-val :lambda-list '(m))
(cl:defmethod oxygen-val ((m <HeartBeat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader heartbeat_ros-msg:oxygen-val is deprecated.  Use heartbeat_ros-msg:oxygen instead.")
  (oxygen m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HeartBeat>)))
  ...
  (cl:format cl:nil "~% Header header             # timestamp of the measurement~%                           # frame_id is the location of the Max30102 sensor~%~% float64 bpm # Expression of the Beat per minute~%~% float64 oxygen          #Oxygen is interpreted SpO2~% ~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HeartBeat)))
  "Returns full string definition for message of type 'HeartBeat"
  (cl:format cl:nil "~% Header header             # timestamp of the measurement~%                           # frame_id is the location of the Max30102 sensor~%~% float64 bpm # Expression of the Beat per minute~%~% float64 oxygen          #Oxygen is interpreted SpO2~% ~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
