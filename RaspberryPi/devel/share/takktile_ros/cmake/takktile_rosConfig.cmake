...
if("TRUE" STREQUAL "TRUE")
  set(takktile_ros_SOURCE_PREFIX /home/tienanh/catkin_ws/src/raspberry_pi)
  set(takktile_ros_DEVEL_PREFIX /home/tienanh/catkin_ws/devel)
  ...
  set(takktile_ros_INSTALL_PREFIX /home/tienanh/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'takktile_ros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'takktile_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tienanh/catkin_ws/src/raspberry_pi/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT takktile_ros_NUM_DUMMY_TARGETS)
      set(takktile_ros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::takktile_ros::wrapped-linker-option${takktile_ros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR takktile_ros_NUM_DUMMY_TARGETS "${takktile_ros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::takktile_ros::wrapped-linker-option${takktile_ros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND takktile_ros_LIBRARIES "${interface_target_name}")
...
set(takktile_ros_EXPORTED_TARGETS "takktile_ros_generate_messages_cpp;takktile_ros_generate_messages_eus;takktile_ros_generate_messages_lisp;takktile_ros_generate_messages_nodejs;takktile_ros_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${takktile_ros_dep}_FOUND)
      find_package(${takktile_ros_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${takktile_ros_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
