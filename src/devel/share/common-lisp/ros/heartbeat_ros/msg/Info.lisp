...
(cl:defmethod cl:initialize-instance :after ((m <Info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name heartbeat_ros-msg:<Info> is deprecated: use heartbeat_ros-msg:Info instead.")))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader heartbeat_ros-msg:frame_id-val is deprecated.  Use heartbeat_ros-msg:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'xyz-val :lambda-list '(m))
(cl:defmethod xyz-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader heartbeat_ros-msg:xyz-val is deprecated.  Use heartbeat_ros-msg:xyz instead.")
  (xyz m))

(cl:ensure-generic-function 'indexes-val :lambda-list '(m))
(cl:defmethod indexes-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader heartbeat_ros-msg:indexes-val is deprecated.  Use heartbeat_ros-msg:indexes instead.")
  (indexes m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Info>)))
  ...
  "65ae3675ccd5c1fffecb419320f4ac07")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Info)))
  "Returns md5sum for a message object of type 'Info"
  "65ae3675ccd5c1fffecb419320f4ac07")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Info>)))
  ...
  (cl:format cl:nil "# message format for raw sensor data~%string frame_id~%geometry_msgs/Point32[] xyz~%int32[] indexes~%~%~%================================================================================~%MSG: geometry_msgs/Point32~%# This contains the position of a point in free space(with 32 bits of precision).~%# It is recommeded to use Point wherever possible instead of Point32.  ~%# ~%# This recommendation is to promote interoperability.  ~%#~%# This message is designed to take up less space when sending~%# lots of points at once, as in the case of a PointCloud.  ~%~%float32 x~%float32 y~%float32 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Info)))
  "Returns full string definition for message of type 'Info"
  (cl:format cl:nil "# message format for raw sensor data~%string frame_id~%geometry_msgs/Point32[] xyz~%int32[] indexes~%~%~%================================================================================~%MSG: geometry_msgs/Point32~%# This contains the position of a point in free space(with 32 bits of precision).~%# It is recommeded to use Point wherever possible instead of Point32.  ~%# ~%# This recommendation is to promote interoperability.  ~%#~%# This message is designed to take up less space when sending~%# lots of points at once, as in the case of a PointCloud.  ~%~%float32 x~%float32 y~%float32 z~%~%"))
