...
"""autogenerated by genpy from heartbeat_ros/Info.msg. Do not edit."""
import codecs
import sys
...
float32 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.indexes))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.indexes = s.unpack(str[start:end])
      return self
