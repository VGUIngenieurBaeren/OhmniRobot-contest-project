...
"""autogenerated by genpy from heartbeat_ros/HeartBeat.msg. Do not edit."""
import codecs
import sys
...
class HeartBeat(genpy.Message):
  _md5sum = "48fe24edbde326dd4f8672f1cc71748c"
  _type = "heartbeat_ros/HeartBeat"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2d().pack(_x.bpm, _x.oxygen))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.bpm, _x.oxygen,) = _get_struct_2d().unpack(str[start:end])
      return self
